 ...
 */
public class RegLiterattiCell extends Activity {

    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","BONE OF CONTENTION", "MEDLEY OF MUSES","SPIN A YARN", "THE HEAD START", "VAKTAVYA","SAMVAAD", "GENERAL QUIZ", "ENTERTAINTMENT QUIZ", "DUMCHARADES","THE TOON'S EYE","GRAFFITI","SPELL BEE","JUST A MINUTE","RACK YOUR BRAIN" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannercell.setText("LITERATI CELL");
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"literary.abhivyakti2k15@gmail.com"};
