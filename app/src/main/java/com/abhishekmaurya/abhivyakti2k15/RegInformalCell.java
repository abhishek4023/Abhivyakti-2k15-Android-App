 ...
 */
public class RegInformalCell extends Activity {

    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","ABHIVYAKTI PREMIER LEAGUE", "COUPLE RACE", "TUG OF WAR", "TREASURE HUNT", "LEMON SPOON RACE", "SACK RACE","BUILDING OF CARDS","BALL IN BETWEEN", "DART GAME","DRIBBLING HURDLE","BANANA RACE" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannercell.setText("INFORMAL CELL");
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"informal.abhivyakti2k15@gmail.com"};
