 ...
 */
public class RegMusicCell extends Activity {
    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","SURTAJ", "RAAG", "BLUES", "SAAMANJASYA", "SYNCHRONICITY", "VAADYA TARAG" };
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"music.abhivyakti2k15@gmail.com"};
