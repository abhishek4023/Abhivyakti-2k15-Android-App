 ...
 */
public class RegStepCell extends Activity {

    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","EKLA A SOLO SOLE", "JITTERBERG" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannercell.setText("CHOREOGRAPHY CELL");
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"choreography.abhivyakti2k15@gmail.com"};
