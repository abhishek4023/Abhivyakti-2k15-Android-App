 ...
 */
public class RegPhotoCell extends Activity {
    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","PHOTO FUNIA", "SELFIE CONTEST","SHORT MAKING MOVIE CONTEST" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannercell.setText("PHOTOGRAPHY CELL");
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"photography.abhivyakti2k15@gmail.com"};
