 ...
 */
public class RegHandicraftCell extends Activity {

    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","NEEDLE AND THREAD", "SAND PAINTING", "CERAMIC WORK", "BEST OUT OF WASTE", "VASE DESIGNING", "MEHENDI DESIGNING" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannercell.setText("HANDICRAFT CELL");
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"handicraft.abhivyakti2k15@gmail.com"};
