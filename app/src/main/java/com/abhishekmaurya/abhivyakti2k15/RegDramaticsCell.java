 ...
 */
public class RegDramaticsCell extends Activity {

    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","BOLLYWOOD QUIZ", "DUMB MAN ACT", "TO B or NOT TO B", "JO DIKHTA HAI VO BIKTA HAI", "I STAND ALONE", "MAI SHAYAR TO NAHI" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannercell.setText("DRAMATICS CELL");
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"dramatics.abhivyakti2k15@gmail.com"};
