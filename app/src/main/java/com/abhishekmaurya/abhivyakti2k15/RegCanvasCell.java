 ...
 */
public class RegCanvasCell extends Activity {

    LinearLayout l1;
    Spinner SpinnerEve, SpinnerMem;
    private String[] eventstr = {"Select Event","RISING STAR", "ETHNICALLY BLACK AND WHITE", "RANGOLI", "PAINT AND SPRAY", "THEME PAINTING" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannercell.setText("CREATIVE CANVAS");
        ...
        regisbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Subj.equals("Select Event") || phonenumb.matches("")  || mem==0 || checkspace==1)
                {
                    ...
                    String emailaddress[] = {"finearts.abhivyakti2k15@gmail.com"};
